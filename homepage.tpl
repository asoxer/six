...
<!-- Slider main container -->
  ...
  <section class="product-list product-list-tiny wrap clearfix">
      <div class="item">
          <div class="header">
              旗舰版PRO
          </div>
          <div class="text">
              <p>终端：20台设备（10 PC + 10 Mobile）</p>
              <p>线路：15-18 条</p>
              <p>带宽：千兆带宽接入</p>
              <p>机房：美国、日本、新加坡、香港</p>
          </div>
      ...
      <div class="row">
          ...
          <div class="col-md-4">
              <div class="item">
                  ...
                  <h3>加密方式</h3>
                  <p>使用行业级加密算法加密，灵活支持AES-256-CFB、RC4-MD5等多种算法。</p>
              </div>
          </div>
          <div class="col-md-4">
              <div class="item">
                  ...
                  <h3>移动端优化</h3>
                  <p>针对移动设备和无线网络进行了优化，不需要任何持久连接。</p>
              </div>
          </div>
          <div class="col-md-4">
              <div class="item">
                  ...
                  <h3>跨平台支持</h3>
                  <p>支持所有主流平台，包括 Windows, Linux, Mac, Android, iOS, and OpenWRT.</p>
              </div>
          </div>
          <div class="col-md-4">
              <div class="item">
                  ...
                  <h3>简单易用</h3>
                  <p>一键上网，支持 PAC 模式，可以指定特定的网站实时穿越</p>
              </div>
          </div>
          <div class="col-md-4">
              <div class="item">
                  ...
                  <h3>声明</h3>
                  <p>天行VPN<sup>pro</sup>是天行VPN的唯一自主品牌，从未做过付费推广，请注意辨别</p>
              </div>
          </div>
      </div>
  </section>
  <section class="wrap introduction">
      <h4>线路丰富，持续扩张的数据中心让跨域体验更流畅</h4>
